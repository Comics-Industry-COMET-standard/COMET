...
2. **Make your edit** in the right place:
...
3. **Do not hand-edit** `schema/comet.schema.json`. Regenerate it with `python3 tools/generate.py`.
4. **Open a pull request** describing the change and the reasoning.

Automated checks validate that your YAML is well-formed and that the schema still builds before a human review.
